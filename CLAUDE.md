...
- **main** — стабильная ветка, деплой в прод
- **feature/название** — фичи (`feature/catalog-ssr`, `feature/cart-zustand`)
- **fix/название** — багфиксы (`fix/cart-total-calculation`)
- **refactor/название** — рефакторинг (`refactor/rtk-to-tanstack`)
- **chore/название** — конфиги, инфра (`chore/eslint-config`)
- PR в **main** — обязателен, ревью перед мержем
- Мерж через **squash** (один коммит на PR в main)
