...
## Статус: 🟡 В работе (шаги 1-2 выполнены)
...
**Статус:** ✅ entity обновлена, `nullable: true` + `@Generated('uuid')`

**UUID для существующих юзеров:** заполнится автоматически — PostgreSQL при ADD COLUMN с DEFAULT gen_random_uuid() применяет дефолт ко всем строкам.

**✅ Выполнено 2026-03-18:**

```sql
-- Заполнить user_identity для существующих Telegram-юзеров
INSERT INTO user_identity ("userId", platform, "externalId")
...
**Статус:** ✅ модуль создан, данные заполнены (2026-03-18)
