...
```typescript
// Web Adapter
export class WebAdapter implements MessengerAdapter {
...
```typescript
// src/shared/lib/messenger/adapters/web-adapter.ts

export class WebAdapter implements MessengerAdapter {
  readonly platform: Platform = 'web';

  private currentUser: MessengerUser | null = null;
  private accessToken: string | null = null;
...
```
Messenger Adapter (уже создан для MAX)
    ├── Telegram Adapter ✅
    ├── MAX Adapter ✅
